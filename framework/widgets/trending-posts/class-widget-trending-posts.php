...
class Widget_Trending_Posts extends Top_News_Widget {
    public function __construct()
    {
        parent::__construct(
            'tn_trending_posts',
            esc_html__('TopNews :: Trending Posts', 'top-news'),
            array('description' => 'Display trending post by recently most viewed posts..' )
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        $query_args = array(
            ...
            'date_query' => array(
                array(
                    'after' => esc_html($time_limit).' day ago',
                ),
            ),
        );
    ...
    function get_options() {
        return array(
            ...
            array(
                'id'      => 'time_limit',
                'type'    => 'number',
                'title'   => esc_html__('Day Ago:', 'top-news'),
                'default'   => '8',
            ),
            array(
                'id'      => 'limit',
