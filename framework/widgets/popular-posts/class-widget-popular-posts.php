...
class Widget_Popular_Posts extends Top_News_Widget {
    public function __construct()
    {
        parent::__construct(
            'tn_popular_posts',
            esc_html__('TopNews :: Popular Posts', 'top-news'),
            array('description' => 'Display popular post by monthly most viewed posts..' )
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        $query_args = array(
            ...
            'date_query' => array(
                array(
                    'after' => esc_html($time_limit).' month ago',
                ),
            ),
        );
    ...
    function get_options() {
        return array(
            ...
            array(
                'id'      => 'time_limit',
                'type'    => 'number',
                'title'   => esc_html__('Month Ago:', 'top-news'),
                'default'   => '12',
            ),
            array(
                'id'      => 'limit',
