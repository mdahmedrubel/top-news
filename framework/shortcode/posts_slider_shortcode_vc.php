...
/**
 * Visual Composer Shortcode of Slider
 */
if ( function_exists( 'vc_map' ) ) {
class WPBakeryShortCode_tn_posts_slider_shortcode extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        top_news_posts_slider_shortcode($title,$cat_id,$categorie_slug,$tag,$orderby,$order,$thumb,$meta,$limit,$el_class);
        return ob_get_clean();	        	         
    }
}
...
vc_map( array(
    "base"                  => "tn_posts_slider_shortcode",
    "name"                  => esc_html__("Slider", 'top-news'),
    "class"                 => "",
    "category"              => esc_html__('TopNews', 'top-news'),
    "icon"                  => get_template_directory_uri().'/images/admin/slider.jpg',
    "params" => array(
        array(
            "type"          => "textfield",
