...
/**
 * Latest Videos Shortcode
 */
if ( function_exists( 'vc_map' ) ) {
class WPBakeryShortCode_tn_latest_video extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
    	...
    	ob_start();	 		    				
        top_news_latest_videos($title,$cat_id,$categorie_slug,$tag,$orderby,$order,$limit,$el_class);
        return ob_get_clean();
...
vc_map( array(
    "base"                  => "tn_latest_video",
    "name"                  => esc_html__("Latest Video Tab", 'top-news'),
    "class"                 => "",
    "category"              => esc_html__('TopNews', 'top-news'),
    "icon"                  => get_template_directory_uri().'/images/admin/video.jpg',
    "params" => array(
        array(
            "type"          => "textfield",
