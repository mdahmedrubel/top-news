...
class WPBakeryShortCode_tn_post_left_thumb extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
    	...
    	ob_start();	 		    				
        top_news_post_left_thumb($title,$cat_id,$categorie_slug,$tag,$orderby,$order,$meta,$limit,$excerpt,$el_class);
        return ob_get_clean();
...
vc_map( array(
    "base"                  => "tn_post_left_thumb",
    "name"                  => esc_html__("Post (left thumb)", 'top-news'),
    "class"                 => "",
    ...
    "params" => array(
        ...
        array(
            ...
            "param_name"    => "excerpt",
            "description"   => esc_html__("Word limit post excerpt Eg: 20, Default value is 20", 'top-news'),
        ),        
    	array(
        "type"              => "textfield",
