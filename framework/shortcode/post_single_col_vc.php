...
/**
 * Visual Composer Shortcode of BLOCK-5- SINGLE COLUMN
 */
if ( function_exists( 'vc_map' ) ) {
class WPBakeryShortCode_tn_post_single_col extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        top_news_post_single_col($title,$cat_id,$categorie_slug,$tag,$orderby,$order,$thumb,$meta,$limit,$excerpt,$el_class);
        return ob_get_clean();		        	         
    }
}
...
vc_map( array(
    "base"                  => "tn_post_single_col",
    "name"                  => esc_html__("Post (1 column / 1 list column)", 'top-news'),
    "class"                 => "",
    "category"              => esc_html__('TopNews', 'top-news'),
    "icon"                  => get_template_directory_uri().'/images/admin/single-col.jpg',
    "params" => array(
        array(
            "type"          => "textfield",
