...
class WPBakeryShortCode_tn_post_default extends WPBakeryShortCode {
    protected function content($atts, $content = null) {
    	...
    	ob_start();	 		    				
        top_news_post_default($title,$post_col,$cat_id,$categorie_slug,$tag,$orderby,$order,$meta,$limit,$show_excrpt,$excerpt,$el_class);
        return ob_get_clean();		        	         
    }
}
...
vc_map( array(
    ...
    "name"                  => esc_html__("Post (default)", 'top-news'),
    "class"                 => "",
    ...
    "params" => array(
        ...
        array(
            ...
            'type'          => 'checkbox',
            'heading'       => esc_html__('Display post excerpt', 'top-news'),
            "description"   => esc_html__("Don't forgot to check 'Yes' if you want to display meta description of post on list", 'top-news')
        ),
        array(
            "type"          => "textfield",
