...
function top_news_featured_posts_thumbslider($top_news_post_from, $cat = '', $tag, $limit) {
    ...
    $the_query = new WP_Query( $query_args );
        if ( $the_query->have_posts() ) :
            $unqID = uniqid();
            ?>
            <div id="slider-<?php echo esc_attr($unqID); ?>" class="flexslider flexslider-fashion2">
                <ul class="slides">
            ...
            <div id="carousel-<?php echo esc_attr($unqID); ?>" class="flexslider flexslider-carousel2">
                <ul class="slides">
                    <?php while ( $the_query->have_posts() ) : $the_query->the_post(); 
                    $meta_data = get_post_meta( get_the_ID(), '_format-video', true );
                    ?>
